...
| macOS x64/arm64                 | Electron DMG                  | Ad-hoc release pipeline verifies native runtime, code seals, no Apple identity, and Gatekeeper rejection; every artifact still needs physical qualification. |

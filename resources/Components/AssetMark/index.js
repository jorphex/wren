...
const artworkEntries = [
  [
    'ethereum-yvusd',
    1,
    ['0x696d02db93291651ed510704c9b286841d506987', '0xaaafea48472f77563961cdb53291dedfb46f9040']
  ],
  [
    'ethereum-yvusds-1',
    1,
    ['0x182863131f9a4630ff9e27830d945b1413e347e8', '0xdc035d45d973e3ec169d2276ddab16f1e407384f']
  ],
  [
    'ethereum-yvweth-1',
    1,
    ['0xc56413869c6cdf96496f2b1ef801fedbdfa7ddb0', '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2']
  ],
  [
    'ethereum-ybold',
    1,
  ...
  [
    'base-yvusdc-h',
    8453,
    ['0xc3bd0a2193c8f027b82dde3611d18589ef3f62a9', '0x833589fcd6edb6e08f4c7c32d4f71b54bda02913']
  ],
  [
    'katana-yvvbusdc',
    747474,
    ['0x80c34bd3a3569e126e7055831036aa7b212cb159', '0x203a662b0bd271a6ed5a60edfbd04bfce608fd36']
  ],
  [
    'katana-yvvbeth',
    747474,
    ['0xe007ca01894c863d7898045ed5a3b4abf0b18f37', '0xee7d8bcfb72bc1880d0cf19822eb0a2e6577ab62']
  ],
  [
    'katana-yvvbusdt',
    747474,
    ['0x9a6bd7b6fd5c4f87eb66356441502fc7dcdd185b', '0x2dca96907fde857dd3d816880a0df407eeb2d2f2']
  ]
]
...
export const resolveAssetArtwork = (asset = {}) => {
  ...
  const assetKey =
    Number.isInteger(Number(asset.chainId)) && address ? `${Number(asset.chainId)}:${address}` : ''

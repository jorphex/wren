...
Use this checklist for the unsigned Wren 0.1.9 Windows installer.
...
- `Wren-Setup-0.1.9-unsigned-x64.exe`
- `SHA256SUMS`
- `wren.cdx.json`
...
```powershell
Get-AuthenticodeSignature '.\Wren-Setup-0.1.9-unsigned-x64.exe' |

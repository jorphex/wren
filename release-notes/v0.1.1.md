...
Wren 0.1.1 is a security, reliability, and wallet-safety update.

## Highlights

- Tracks canonical transaction receipts and handles chain reorganizations,
...
- Adds optional confirmed-recipient history and stronger OS or hardware signer
  protection.
- Reduces browser identity data retained during Companion authentication.
...
Install Wren 0.1.1 before Wren Companion 0.1.1. The pair uses mutually

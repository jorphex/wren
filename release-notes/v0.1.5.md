...
Wren 0.1.5 improves Control Center and wallet layouts. Activity rows now open
detail views. Transaction references stay available for the 90-day Activity
history period without storing private request contents.
...
- Control Center keeps Home, Accounts, Networks, App activity, and Settings
  visible. It shows account, active-network, and app counts where available.
...
- Account details and portfolio balances are easier to scan. Transaction and
  signing controls remain prominent.

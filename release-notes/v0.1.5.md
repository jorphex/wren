...
Wren 0.1.5 is an interface and Activity-context release. It refreshes the visual
hierarchy throughout the desktop and wallet, makes Activity rows useful detail
views, and keeps privacy-safe transaction references available for the same 90-day
window as Activity history.

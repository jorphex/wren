...
locked accounts, and makes wallet layouts more consistent.
...
- Wallet, Control Center, and review screens use the same top bar, content
  grid, translucent cards, and spacing.

...
- Transaction reviews now group the decoded action, editable fee and nonce,
  estimated asset changes, contract data, and signer actions more clearly.
- Token approvals offer exact, custom, unlimited, and revoke choices without
  hiding the resulting allowance.
...
- Selecting a locked software or hardware account continues to its password,
  device PIN, passphrase, or reconnect flow. Ready accounts switch directly.
